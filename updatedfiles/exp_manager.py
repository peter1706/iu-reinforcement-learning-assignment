...
class ExperimentManager:
    ...
    def __init__(
        ...
        # TODO hyperparams are specified here and may have to change
    ...
    def _preprocess_hyperparams(  # noqa: C901
        ...
        # TODO n evaluations during hyperparameter optimization of pruning
        ...
        # TODO here we could use it to import a custom policy from sb3 
        ...
        # TODO do we have to specify the wrapper class for the optimization
        # here it reads the class for the wrapper of the environment
    ...
    def create_envs(self, n_envs: int, eval_env: bool = False, no_log: bool = False) -> VecEnv:
        ...
        # TODO use stable baselines for making environment
        env = make_vec_env(
            make_env,
            n_envs=n_envs,
            seed=self.seed,
    ...
    def _create_sampler(self, sampler_method: str) -> BaseSampler:
        ...
        if sampler_method == "random":
            ...
            sampler = GPSampler(seed=self.seed, n_startup_trials=5)
    ...
    def objective(self, trial: optuna.Trial) -> float:
        ...
        # TODO here the sampled hyperaparamters are set
        ...
        # TODO does it use the Atari Wrapper
        model = ALGOS[self.algo](
            env=env,
    ...
    def hyperparameters_optimization(self) -> None:
        ...
        # TODO runs the actual optimization using optuna
        try:
        ...
        # TODO pickle containts optuna study that can be investigated!
        ...
        try:
            ...
            # TODO plottng param_importances does not work!
            # fig2 = plot_param_importances(study)

            fig1.show()
            # fig2.show()
        except (ValueError, ImportError, RuntimeError):
            print(f"No optimiation plots have been generated!")
            pass
